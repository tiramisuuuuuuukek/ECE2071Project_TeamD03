...
def choose_stm_port():
    ...
    intput: n/a
    returns: n/a
    function: searches comupter ports for stm and automatically connects to the stm
    '''
...
def startup():   
    '''
    inputs: n/a 
    outputs: list of recording method and time/distance and end sequence
    funciton: ask user for inputs for distance or time based measuremnets and its associated time or distance 
    '''  
    valid = 0
...
def recive_data(ser):
    ...
    inputs: serial port
    outputs: n/a
    funciton: reads data until endsequence is shown then plots into graph and converts to png and .wav file
    '''
    data = []
    buffer = []
